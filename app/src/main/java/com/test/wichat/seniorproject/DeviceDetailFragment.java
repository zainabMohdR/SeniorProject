...
import com.test.wichat.seniorproject.DeviceListFragment.DeviceActionListener;
import com.test.wichat.seniorproject.WiFiDirectApp.PTPLog;
...
public class DeviceDetailFragment extends Fragment {
    ...
    public void onConnectionInfoAvailable(final WifiP2pInfo info) {
        Log.d(TAG, "inside on info available");
        ...
        Log.d(TAG, "group owner is set");

        // InetAddress from WifiP2pInfo struct.
        view = (TextView) mContentView.findViewById(R.id.device_info);
        view.setText("Group Owner IP - " + info.groupOwnerAddress.getHostAddress());
        Log.d(TAG, "group owner ip text is set");

        Log.d(TAG, "onConnectionInfoAvailable(how did we get here?): " + info.groupOwnerAddress.getHostAddress());
